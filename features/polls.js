...
.wap-poll:hover {
  box-shadow:
    0 6px 32px rgba(100,80,140,.15),
    0 1px 0 rgba(255,255,255,.8) inset;
}

/* When inside our own chat bubble */
.mine .wap-poll{
  background: rgba(255,255,255,0.82);
  border-color: rgba(167,139,202,0.30);
}

/* Dark mode */
[data-theme="dark"] .wap-poll {
  background: rgba(30,26,50,0.72);
  border-color: rgba(167,139,202,0.18);
  box-shadow:
    0 4px 24px rgba(0,0,0,.28),
    0 1px 0 rgba(255,255,255,.06) inset;
}
[data-theme="dark"] .mine .wap-poll {
  background: rgba(40,32,64,0.78);
}

/* In posts feed — full width, no max-width cap */
.wap-post-poll .wap-poll,
.wap-post-poll .wap-poll-ph .wap-poll {
  max-width: 100%;
  border-radius: 14px;
}

.wap-poll-top { padding: .9rem 1.05rem .6rem; }
.wap-poll-q {
...
/* ─── Options ───────────────────────────────────────────── */
.wap-poll-opts { padding: .05rem 0 .12rem; }

.wap-poll-opt {
  display: flex; flex-direction: column;
  padding: .5rem 1.05rem .42rem;
